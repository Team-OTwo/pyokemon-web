const SeatingChart = ({ onSeatGradeSelect }: { onSeatGradeSelect: (grade: string) => void }) => {
  return (
    <div className="flex flex-col items-center gap-30 p-30 rounded-lg">
      <h2 className="text-gray-700 text-2xl font-bold">좌석 배치도</h2>
      ...
      <div className="grid grid-cols-5 grid-rows-[auto_auto_auto_auto] gap-15 max-w-4xl w-full relative">
        ...
        <div
          className="bg-black col-start-2 col-span-3 row-start-1 rounded-lg flex justify-center items-center min-h-80"
        ...
        {/* VIP 좌석 */}
        <div
          className="col-start-2 row-start-2 rounded-lg flex justify-center items-center h-190 bg-primary-dark mt-30"
